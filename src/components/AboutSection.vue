    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center text-lg-start">
          ...
          <ul class="list-unstyled d-flex flex-wrap justify-content-center justify-content-lg-start gap-3">
            <li class="badge bg-info text-dark py-2 px-3 fs-6">HTML5</li>
            <li class="badge bg-info text-dark py-2 px-3 fs-6">CSS3</li>
            ...
            <li class="badge bg-warning text-dark py-2 px-3 fs-6">PostgreSQL</li>
